...
public class UserController {
    ...
    @ResponseBody
    public ServerResponse<String> forgetRestPassword(String username, String passwordNwe, String forgetToken) {
        return iUserService.forgetResetPassword(username, passwordNwe, forgetToken);
    }

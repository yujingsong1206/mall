...
public class RedisPool {
    ...
    private static String redisId = PropertiesUtil.getProperty("redis.id");
    ...
    private static void initPool(){
        ...
        pool = new JedisPool(config,redisId,redisPort,1000*2);//timeout单位是毫秒
    }

...
public class UserServiceImpl implements IUserService {
    ...
    @Override
    public ServerResponse<String> forgetResetPassword(String username, String passwordNwe, String forgetToken) {
        ...
        if(StringUtils.equals(forgetToken, token)) {
            String md5Password = MD5.getMessageDigest(passwordNwe);
